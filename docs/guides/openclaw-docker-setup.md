...
- `PAPERCLIP_HOST_PORT` (default `3200`)
...
- For invite/onboarding URLs consumed by OpenClaw in Docker, use the script-printed Paperclip URL (typically `http://host.docker.internal:3200`).
